...
const PRICES_CONFIG = {
    mains: {
        gel: {
            poseComplete: { price: 70, label: "POSE COMPLÈTE", description: "Rallongement de l'ongle sans capsule. Longueur et solidité. Idéal pour ongles rongés ou abîmés" },
            remplissage: { price: 48, label: "REMPLISSAGE", description: "Comblement de la repousse naturelle des ongles. Toutes les 3 à 4 semaines" },
            kapping: { price: 40, label: "KAPPING", description: "Permet une solidité de l'ongle sans rallongement" },
    ...
    pieds: {
        gel: {
            posePieds: { price: 40, label: "POSE PIEDS", description: "Apporte de la solidité à vos ongles de pieds. Tenue de 6 à 8 semaines. Permet de réparer des ongles accidentés" },
    ...
    supplements: {
        limageVernisPieds: { price: 15, label: "Limage et pose vernis pieds lors d'une prestation mains" },
        limageVernisMains: { price: 15, label: "Limage et pose vernis mains lors d'une prestation pieds" },
